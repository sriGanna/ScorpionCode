/*
 ...
 MSE 2202 MSEBot base cod; for Labs 3 and 4
 Language: Arduino
...
//THIS IS OUR CODE BITCHES
boolean justEntered= false;
boolean leftLed = false, middleLed = false, rightLed=false;
...
const int ci_Arm_Servo_Retracted = 40;      //  "
...
void setup() {
  ...
  //OUR CODE
  // int DARK = (ui_Middle_Line_Tracker_Dark + ui_Right_Line_Tracker_Dark + ui_Middle_Line_Tracker_Dark)/3;
  // int LIGHT = (ui_Middle_Line_Tracker_LIGHT + ui_Right_Line_Tracker_LIGHT + ui_Middle_Line_Tracker_LIGHT)/3;
  int DARK = 851;
  int LIGHT = 850;
}
  ...
  switch(ui_Robot_State_Index)
  {
    ...
    case 1:    //Robot Run after 3 seconds
    {
      if(bt_3_S_Time_Up)
      {
       ...
       /*************************************************************************************/
 if (leftLed == true && middleLed == true   && rightLed == true )
{
  justEntered = true;
   ui_Left_Motor_Speed = 1500;
    ui_Right_Motor_Speed =  1500;
    if (stopPointCounter == 0)
    {
      ui_Left_Motor_Speed = 1700;
    ui_Right_Motor_Speed =  1700;
    delay(100);
      ui_Left_Motor_Speed =  1800;//turn and find other track
      ui_Right_Motor_Speed = 1400;
     // stopPointCounter++;
    }
    else if(stopPointCounter == 1)//grab target
    {
      
      servo_GripMotor.write(ci_Grip_Motor_Open);
      /*
      while(analogRead(ci_Light_Sensor) < 800)
      {
        ui_Left_Motor_Speed =  1510;
      }
      */
      delay(2000);
    ...
    else if(stopPointCounter == 2)
    {
      //delay(2500);
      ui_Right_Motor_Speed =  1510;
     // stopPointCounter++;
    }
   /* else if(stopPointCounter == 3)
    {
      ui_Left_Motor_Speed =  1700;
    }*/
}
 ...
 if(leftLed == false && middleLed == true && rightLed == false)
  {
    ui_Left_Motor_Speed = 1600;
    ui_Right_Motor_Speed =  1600;
    }
else if(leftLed == false  && middleLed == false  && rightLed == true)
{
   ui_Left_Motor_Speed = 1650;
    ui_Right_Motor_Speed =  1550;
}

else if(leftLed == true && middleLed == false  && rightLed == false )
{
   ui_Left_Motor_Speed = 1600;
...
else if(leftLed == false && middleLed == false   && rightLed == false  )
{
 
      if(stopPointCounter == 1) //this is one ahead of the first stop point, because it increments before getting here //for the first stop point
   {
    ui_Left_Motor_Speed = 1600;
    ui_Right_Motor_Speed =  1400;
   }
  else if(stopPointCounter == 2) //for the 2nd stop point
   {
...
else if(leftLed == true && middleLed == true && rightLed == false)
{
   ui_Left_Motor_Speed = 1600;
    ui_Right_Motor_Speed =  1600;
}

else if(leftLed == false   && middleLed == true && rightLed == true)
{
   ui_Left_Motor_Speed = 1600;
    ui_Right_Motor_Speed =  1600;
}
